...
var colors = [0x265897, 0x13acfa, 0x009a49, 0xc0000b, 0xa1cb50, 0xB11B23,
              ...
              0xCCCCCC, 0xEEEEEE];
//colors = [0xFFFFFF, 0x000000, 0xcba84a, 0x6a9c5f, 0x4c97a4, 0xf7ad40, 0x3f94c3, 0x8fb587, 0xf8b758, 0x57a1cb, 
...
CountdownParticle.prototype.implode = function() {
  new TWEEN.Tween(this.particle.position)
    ...
    .to({x: this.originX - 400, y: this.originY + 350, z: this.originZ}, 1000)
